...
Hay **dieciocho ADRs**, todos **aprobados e inmutables**. Para cambiar uno
...
tests/        model/ raw/ db/ alias/ calendar/ stores/ types/ mirror/ site/ · fixtures/ SOLO sintéticos
