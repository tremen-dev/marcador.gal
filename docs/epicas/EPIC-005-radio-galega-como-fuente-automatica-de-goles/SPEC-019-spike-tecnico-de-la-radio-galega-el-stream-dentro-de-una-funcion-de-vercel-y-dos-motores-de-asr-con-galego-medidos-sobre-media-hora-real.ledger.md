...
- **Gate del 2026-09-13 (Alberto Fojo, registrado por `sdd-arquitecto`):** F-SPEC-019-1, -2 y -3 decididos y el **cuerpo de la spec enmendado** (CA-7.1, CA-5.2, CA-1 y CA-7.5, con nota fechada junto a cada uno). Constancia en los ledgers de SPEC-009 y SPEC-018 (`## Enmienda — 2026-09-13`). Lo que el implementador tiene que hacer ahora está en cada finding, abajo.
