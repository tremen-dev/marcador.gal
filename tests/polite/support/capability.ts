...
export const SCAN_EXCLUSIONS: readonly ScanExclusion[] = [
  ...
  },
  {
    path: 'spikes/',
    motive:
      "Disposable spike code (ADR-029, SPEC-019 §1). It is outside the production deployment and outside `rutasVigiladas` of `.sdd.json`, and it does not enter typecheck, lint or build — the three root lines of SPEC-019 §1 keep it out. It is deleted when EPIC-005 closes, and this entry leaves in the same commit that deletes `spikes/`. Declared here, and not left to silence, because CA-2.6 asks that being outside be a decision (amendment in the SPEC-009 ledger, 2026-09-13).",
  },
];
